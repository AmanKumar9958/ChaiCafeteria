...
const WhatsAppButton = () => {
    const phoneNumber = "919155354939";
    const message = "Hello! I saw your cafe's website and I'd like to ask a question.";
    ...
    return (
        <a
            href={whatsappUrl}
            className="fixed bottom-5 right-5 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-lg hover:bg-[#1DA851] transition-colors duration-300 flex items-center justify-center"
            target="_blank"
